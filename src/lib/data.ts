...
export const PROJECTS = [
  ...
  {
    title: 'Проект "Приморский комплекс"',
    image: "https://cdn.poehali.dev/projects/6cec83f6-886a-402c-8698-2003e58f639f/bucket/fe639de3-2633-44eb-a5ad-03e0a51ba22f.png",
    stats: ["📐 от 45 кв.м", "🏡 Несколько корпусов"],
    description: "Комплекс из нескольких домиков среди леса с общей ландшафтной зоной и костровой площадкой. Подходит для базы отдыха или семейного поместья.",
    price: "от 4 500 000 ₽",
  },
];
